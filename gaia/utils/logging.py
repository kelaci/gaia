...
def create_performance_logger(name: str = 'gaia.performance') -> logging.Logger:
    """
...
def create_debug_logger(name: str = 'gaia.debug') -> logging.Logger:
    """
