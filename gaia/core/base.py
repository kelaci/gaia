...
class Module(ABC):
    ...
    All components in GAIA inherit from this base class, providing
...
class Layer(Module):
    ...
    Layers are the fundamental processing units in GAIA, implementing
