"""
Basic demonstration of GAIA's hierarchical processing capabilities.
...
def basic_demo():
    ...
    logger.info("Starting GAIA basic demo")
    ...
    plot_hierarchy_representations(sample_reps, title="GAIA Hierarchical Processing")
    ...
    logger.info("GAIA basic demo completed successfully")
